const translations = {
    uk: {
        ...
        biannualDesc: "Чесний Блог | Система росту Хочеш зростати в соцмережах не «за рілсами», а за системою, яка дійсно приводить клієнтів? Підписка для тих, хто будує особистий бренд і хоче стабільних результатів: охоплення, залучення, довіра, продажі. Що ви отримаєте: Модуль «Будуємо особистий бренд з нуля» Контент-план на місяць 2 прямих ефіри на місяць: тренди + розбір ситуацій Алгоритми та стратегії зростання в Instagram Закритий чат з підтримкою Щомісячні фокуси для прокачування особистого бренду",
    ...
    ru: {
        ...
        biannualDesc: "Честный Блог | Система роста. Хочешь расти в соцсетях не \"по рилсам\", а по системе, которая реально приводит клиентов? Подписка для тех, кто строит личный бренд и хочет стабильных результатов: охваты, вовлечённость, доверие, продажи. Что вы получите: Модуль \"Строим личный бренд с нуля\" Контент-план на месяц 2 прямых эфира в месяц: тренды + разборы ситуаций Алгоритмы и стратегии роста в Instagram Закрытый чат с поддержкой Ежемесячные фокусы для прокачки личного бренда",
...
function initCountdown() {
    const countdownDate = new Date().getTime() + (0 * 24 * 60 * 60 * 1000); // 7 days from now
