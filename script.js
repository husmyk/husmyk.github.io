const translations = {
    uk: {
        ...
        biannualDesc: "Чесний Блог | Система росту<br>Хочеш ростати в соцмережах не «за рілсами» а за системою, яка дійсно приводить клієнтів?<br>Підписка для тих, хто будує особистий бренд і хоче стабільних результатів: охоплення, залучення, довіра, продажі.<br>Що ви отримаєте:<br>Модуль \"Будуємо особистий бренд з нуля\"<br>Контент-план на місяць<br>2 прямих ефіри на місяць: тренди + розбір ситуацій<br>Алгоритми та стратегії зростання в Instagram<br>Закритий чат з підтримкою<br>Щомісячні фокуси для прокачування особистого бренду",
